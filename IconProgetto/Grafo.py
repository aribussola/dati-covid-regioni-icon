...
# A* search
def astar_search(graph, heuristics, start:Regione, end:Regione):
    ...
    while len(open) > 0:
        ...
        for key, value in neighbors.items():
            ...
            neighbor.g = (current_node.g + graph.get(current_node.name, neighbor.name))/2
